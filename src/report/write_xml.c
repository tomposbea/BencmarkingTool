...
void print_avg_to_xml(){
	...
	int run_sec;
        ...
        fprintf(f,"\t<cpuusage>%lld</cpuusage>\n", avg_usage);
        fprintf(f,"\t<memusage>%lld</memusage>\n", avg_usage2);
        fprintf(f,"\t<memlimit>%s</memlimit>\n", limit);

        //program output
        fprintf(f,"\t<gen>%8.8lld</gen>\n", avg_generated);
        fprintf(f,"\t<drop>%8.8lld</drop>\n", avg_dropped);
        fprintf(f,"\t<proc>%8.8lld</proc>\n", avg_processed);
        fprintf(f,"\t<dup>%8.8lld</dup>\n", avg_duplicate);
        fprintf(f,"\t<duphash>%8.8lld</duphash>\n", avg_hash);
        fprintf(f,"\t<duptable>%8.8lld</duptable>\n", avg_table);
        fprintf(f,"\t<duprbtree>%8.8lld</duprbtree>\n", avg_tree);
        fprintf(f,"\t<dupbstree>%8.8lld</dupbstree>\n", avg_bstree);
